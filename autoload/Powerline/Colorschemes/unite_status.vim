...
let g:Powerline#Colorschemes#unite_status#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['fileinfo.flags'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['current_function', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'tagbar:currenttag', 'charcode', 'currhigroup'], {
		\ 'n': ['gray8', 'gray2'],
		\ 'N': ['darkred'],
